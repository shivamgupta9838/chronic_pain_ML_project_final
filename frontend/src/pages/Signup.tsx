        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="space-y-1 pb-6">
            ...
            <div className="mt-4 flex items-center justify-center gap-2">
              ...
              <div className={`h-1 w-12 rounded-full ${step >= 2 ? 'bg-teal-500' : 'bg-slate-200'}`} />
              <div className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      {errors.lastName && <p className="text-sm text-rose-500">{errors.lastName}</p>}
                    </div>
                  </div>
            ...
            {step === 2 && (
              <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        {[1, 2, 3, 4].map((index) => (
                          <div
                            ...
                            className={`h-1.5 flex-1 rounded-full transition-colors ${
                              index <= getPasswordStrength() ? strengthColors[getPasswordStrength() - 1] : 'bg-slate-200'
                            }`}
                          />
                        ))}
                      </div>
                      <p className={`text-xs ${
                        getPasswordStrength() > 0
                          ? strengthColors[getPasswordStrength() - 1].replace('bg-', 'text-')
                          : 'text-slate-500'
                      }`}>
                ...
                <div className="space-y-2">
                  ...
                  {errors.agreeTerms && <p className="text-sm text-rose-500">{errors.agreeTerms}</p>}
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    type="submit"
                    className="flex-1 bg-gradient-to-r from-teal-500 to-cyan-600 text-white hover:from-teal-600 hover:to-cyan-700"
                    disabled={isLoading}
                  >
                    {isLoading ? (
